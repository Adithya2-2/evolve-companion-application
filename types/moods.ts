...
export const moodOptions: MoodOption[] = [
    { name: 'Joyful', icon: 'mood', description: 'Feeling ecstatic and full of positive energy!', score: 10 },
    ...
    { name: 'Sad', icon: 'sentiment_dissatisfied', description: 'Feeling down and in need of comfort.', score: 2 },
    { name: 'Anxious', icon: 'mood_bad', description: 'Feeling worried, nervous, or uneasy.', score: 2 },
    { name: 'Angry', icon: 'local_fire_department', description: 'Feeling frustrated, irritated, or upset.', score: 1 },
];
