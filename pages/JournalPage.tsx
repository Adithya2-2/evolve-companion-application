...
const JournalPage: React.FC<JournalPageProps> = ({ journalHistory, upsertJournalEntry }) => {
        ...
        <header className="flex justify-between items-end mb-8">
            <div>
                ...
                <h2 className="text-3xl md:text-5xl font-bold text-text-light tracking-tight">
                    <span className="animate-title-reveal" style={{animationDelay: '0.1s'}}>Daily Reflection</span>
                </h2>
            </div>
            <div className="flex gap-3">
                ...
                />
                <button className="bg-surface-dark border border-white/10 hover:border-primary/50 text-slate-300 hover:text-white p-3 rounded-xl transition-all shadow-lg">
